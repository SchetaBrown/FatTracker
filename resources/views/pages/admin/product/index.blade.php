            ...
            <table class="w-full">
                <thead>
                    <tr class="bg-gray-50 border-b border-gray-200">
                        <th class="text-left py-3 px-4 text-sm font-medium text-gray-700">Название</th>
                        <th class="text-left py-3 px-4 text-sm font-medium text-gray-700">Калории</th>
                        <th class="text-left py-3 px-4 text-sm font-medium text-gray-700">Белки (гр.)</th>
                        <th class="text-left py-3 px-4 text-sm font-medium text-gray-700">Жиры (гр.)</th>
                        <th class="text-left py-3 px-4 text-sm font-medium text-gray-700">Углеводы (гр.)</th>
                        <th class="text-left py-3 px-4 text-sm font-medium text-gray-700">Категория</th>
                        <th class="text-left py-3 px-4 text-sm font-medium text-gray-700">Действия</th>
                    </tr>
                </thead>
                <tbody>
                            ...
                            <td class="py-3 px-4">
                                <div class="flex space-x-2">
                                    ...
                                    <form action="{{ route('admin.product.destroy', ['product' => $product]) }}"
                                        ...
                                        @csrf
                                        @method('DELETE')
                                        <button href="" class="text-red-600 hover:text-red-800">
