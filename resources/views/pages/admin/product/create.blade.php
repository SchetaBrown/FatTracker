...
@section('content')
    <main class="max-w-2xl mx-auto px-4 py-6">
        <form class="bg-white rounded border p-6 space-y-6 border-gray-200" action="{{ route('admin.product.store') }}"
            method="POST">
            @if ($errors->any())
            ...
            <div>
                ...
                <input type="text" required placeholder="Введите название" name="title"
            ...
            <div>
                ...
                <textarea rows="3" placeholder="Описание продукта (необязательно)" name="description"
                    class="w-full px-3 py-2 border rounded focus:ring-1 focus:ring-blue-500 focus:border-blue-500 border-gray-200"></textarea>
            </div>
